...
import { money, one, dateTime } from "@/core/format";
import type { Approval, StockLevel, StockStatus } from "@/core/types";
...
export function InventoryPage() {
  ...
  const stock = useAsync(() => adapters.inventory.getStockLevels(locationId), [locationId]);
